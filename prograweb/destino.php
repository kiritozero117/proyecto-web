<?php    
    ...
    $query = mysqli_query($db, "SELECT Titulo, autor, imagen, contenido, categoria FROM articulo WHERE categoria = 'Destino'");    
...
<body>
    ...
    <div class="text-center">
            <h1 aling="center"><b><i>ARTICULOS DE LUGARES DE DESTINO</i></b></h1>            
            <hr class="my-4">
    </div>
