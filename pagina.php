            ...
            function obUsu($conBD) {
               ...
               if (mysqli_num_rows($res) > 0) {
                  while ($fila = mysqli_fetch_assoc($res)) {
                     ...
                     $filTa .= "<td>" . $fila["titulo"] . "</td>";
                     $filTa .= "<td>" . $fila["autor"] . "</td>";
                     $filTa .= "<td>" . $fila["precio"] . "</td>";
                     $filTa .= "<td>" ."<form id='form1' name='form1' method='post' action='editar.php?id= '.$id>". "<button name='editar' type='submit' class='btn btn-success' >Editar</button>"."</form>"."</td>";
                     $filTa .= "<td>" ."<form id='form1' name='form2' method='post' action='borrar.php?id= '.$id>". "<button name='borrar' type='submit' class='btn btn-success' >Borrar</button>"."</form>". "</td>";
                     $filTa .= "</tr>";
                  }  
               ...
               if ($conBD) {
                  ...
                  <div class='border-success'>
                     ...
                     ."<th>Titulo</th>" . "<th>Autor</th>". "<th>Precio</th>". "<th>Editar</th>". "<th>Eliminar</th>"."</tr>" .$filas . "  </table>" ."</div>"; echo $tabla;
               }
               else {
